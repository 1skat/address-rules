...
export const solanaRpc = createSolanaRpc("https://devnet.helius-rpc.com/?api-key=f0071628-74f7-41c7-82af-c11fe8f7a768");

const mintInfo = await solanaRpc.getAccountInfo(
    address("Cz42xD8eBC8hiNthY3YhFXoA1qfUcfzDzLvXzn9AXSTk"),
    { encoding: "base64" }
).send();

console.log(mintInfo.value?.owner);
// const mint = address("4zMMC9srt5Ri5X14GAgXhaHii3GnPAEERYPJgZJDncDU")


// const metadata = await fetchMetadataFromSeeds(solanaRpc, { mint });
